...
def get_siamese_model(input_shape, embedding_dim=128):
    ...
    path_res = "/content/drive/My Drive/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5"
    resnet_model = VGG16(weights= path_res, include_top = False, input_tensor=resnet_input)
...
model.save("/content/drive/My Drive/IML Project 4 Data/vgg16_model.h5")
...
model = load_model("/content/drive/My Drive/IML Project 4 Data/vgg16_model.h5", compile = False)  
...
#Save predictions
np.savetxt("VGGC16_PREDS.txt",pred, fmt="%d")